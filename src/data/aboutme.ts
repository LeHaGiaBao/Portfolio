...
export const homeintro = [
	'An individual passionate developer 🚀 having experience in building Web with JavaScript / TypeScript / ReactJS / NextJS and some other cool libraries and frameworks.',
]
...
export const goal = [
	"🎯 My goal is to become a Fullstack Web Developer, and I'm willing to put in the hard work to improve my skills. Recently, I've also been exploring the Mobile Development field and I'm excited to see where this journey takes me.",
]

export const roadmap = [
	"📌 In the next few years, my roadmap is to become a Web and Mobile Developer. I'm always eager to learn and explore new arenas, and I believe that with dedication and a strong work ethic, I can achieve my goals. I'm grateful for the opportunities and experiences that have brought me to where I am today, and I'm excited to see what the future holds. Thank you for taking the time to read my story!",
]

export const introwork = [
	"As an individual passionate developer 🧑🏻‍💻, I'm proficient in a range of technical skills, including Frontend and Backend Web Development, Database management, and a little bit of Mobile Development. I have experience in using JavaScript / TypeScript / ReactJS / NextJS and some other cool libraries and frameworks. I'm excited to continue honing my skills and exploring new technologies to take my contributions to the next level.",
]
