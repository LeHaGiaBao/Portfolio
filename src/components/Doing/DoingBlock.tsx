...
function DoingBlock({ image, title, content }: DoingBlock) {
    return (
        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }}>
            <div className="h-full overflow-hidden text-slate-800 border border-gray-200 dark:border-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md shadow">
