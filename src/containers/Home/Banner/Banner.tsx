...
function Banner() {
    return (
        <>
            <section className="pt-14 md:pt-32 lg:pt-32">
                <div className="container grid gap-6 mx-auto text-left lg:grid-cols-2 xl:grid-cols-5">
                    <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-3">
                        <motion.div
                            ...
                            <h1 className="lg:text-7xl text-4xl font-bold leading-none sm:text-6xl flex text-gray-700 dark:text-gray-300">
                                👋 Hi
                            </h1>
                            <p className="text-4xl font-bold leading-none sm:text-6xl lg:text-7xl mt-3 text-gray-700 dark:text-gray-300">I&apos;m {" "}
                                <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-400 -z-50">Le Ha Gia Bao</span>
                            </p>
                            <p className="lg:text-2xl text-xl my-5 text-slate-800 dark:text-gray-300">
                                {welcome}
                            </p>
                            <p className="lg:text-2xl text-xl my-5 text-slate-800 dark:text-gray-300">
                                {homeintro}
