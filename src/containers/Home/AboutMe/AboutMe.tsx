...
function AboutMe() {
    return (
        <>
            <section className="pt-10 pb-20 overflow-hidden text-slate-800 dark:text-gray-300">
                        ...
                        <Fade right>
                            <div>
                                <p className="max-w-xl mt-3 text-xl leading-relaxed md:mt-8">
                                    My name&apos;s Bao, Le Ha Gia Bao
                                    {' '}
                                    {/* <span className="relative inline-block">
                                        <span className="absolute inline-block w-full bottom-1 h-1 bg-gradient-to-r from-cyan-500 to-blue-500"></span>
